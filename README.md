...
|-------------|--------------------|
| **Statistique & Modélisation** | Régressions (logistique, Poisson, Cox), modèles mixtes, classification latente (flexmix, randomLCA), imputations multiples, validation croisée |
...
### 🔹 **INSERM – CERPOP / ADERA (Toulouse, France)**  
